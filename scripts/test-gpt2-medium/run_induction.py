"""GPT-2 Medium induction protocol (reproduce GPT-2 Small result).

Same defaults as small: score=attn_x_vnorm, k=15, B=4, ban_bos.
...
if __name__ == "__main__":
    run_induction_eval(sys.argv[1:], default_model="gpt2-medium")
